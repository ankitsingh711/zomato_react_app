...
const url = "https://ankit-zomato-data.herokuapp.com/filter"
...
class CostFilter extends Component{
    ...
    render(){
        return(
            <Fragment>
                <center style={{color:"black",fontSize:"25px",fontStyle:"italic"}}>Cost Filter</center>
                <div className="my-3" style={{marginLeft:'30%'}} onChange={this.filterCost}>
